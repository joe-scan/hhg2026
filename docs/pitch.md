...
Hiring is driven by order volume, not by dates, and nobody is hired before the orders exist.
...
Amounts and criteria change, so every one of these needs confirming with the Local Enterprise Office before it goes into an application. As of writing, the relevant ones are:

- **Local Enterprise Office:** Trading Online Voucher, Priming Grant, and a feasibility grant for market research in the United States.
- **Enterprise Ireland:** New Frontiers for the founder programme and stipend, and High Potential Start-Up status, which is aimed at companies targeting around $1M of export sales within three years and creating ten jobs. That is the same target this plan is built around.

## Contact

Joe Scanlon, hello@happyherogames.com, happyherogames.com
