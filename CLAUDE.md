...
- **The boss fight is in the game, not in the pitch.** Every paid game still ends with one. It came out of the selling copy on 20 Sep 2026 because it was one more thing to explain before somebody understood the simple part: five games, their own family, their name at the end. Finding it should be a surprise.
...
- **The menu is four plain links: Price, Christmas game, Halloween game, Questions.** No dropdown, and no "Build a game" link, because on the front page that scrolled to the top of the page somebody was already on. Two things called free, the demo and the seasonal games, is what made it confusing.
