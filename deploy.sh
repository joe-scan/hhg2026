...
for p in '' free/ free/christmas/ free/halloween/ order/ privacy/ terms/ g/demo/ es/ ga/free/halloween/ order.php builder.js arcade/engine.js arcade/free.js css/site.css img/og.png img/logo.svg; do
