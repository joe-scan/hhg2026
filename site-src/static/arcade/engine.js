...
const MENU = [
  ['1 PLAYER', 'THE COMPUTER PLAYS THE FAMILY'],
  ['2 PLAYERS', 'A GROWN-UP PLAYS THE FAMILY'],
  ['PARTY MODE', 'EVERYONE TAKES A TURN AGAINST THE HERO']
];
...
window.addEventListener('keydown', e => {
  ...
  if (kpos === KONAMI.length) { kpos = 0; bigHead = !bigHead; sfx.power(); floatText(bigHead ? 'BIG HEAD MODE!' : 'NORMAL HEADS', W / 2, 120, COL.green, 16); }
});
