...
function gPaddle() {
  const s = { name: 'BATTAGLIA DI RACCHETTE', how: ['UNA PALLA, DUE RACCHETTE.', 'BLOCCA, POI MIRA CON IL BORDO.', 'VINCE CHI ARRIVA A 3.'], ctl: 'MUOVITI: SU E GIU', pts: [0, 0], done: -1 };
  ...
  function point(i) {
    s.pts[i]++; shake = 6; sfx.score(); floatText(PL[i].name + ' SEGNA!', W / 2, 120, PL[i].col, 16); cheer(i, W / 2, 142, s.pts);
...
addGame('BATTAGLIA DI RACCHETTE', gPaddle);
