...
function gPaddle() {
  const s = { name: 'BATAILLE DE RAQUETTES', how: ['UNE BALLE, DEUX RAQUETTES.', 'BLOQUE, PUIS VISE AVEC LE BORD.', 'PREMIER A 3 GAGNE.'], ctl: 'BOUGE : HAUT ET BAS', pts: [0, 0], done: -1 };
  ...
  function point(i) {
    s.pts[i]++; shake = 6; sfx.score(); floatText(PL[i].name + ' MARQUE !', W / 2, 120, PL[i].col, 16); cheer(i, W / 2, 142, s.pts);
...
addGame('BATAILLE DE RAQUETTES', gPaddle);
