...
function gPaddle() {
  const s = { name: 'CATH NA MAIDI', how: ['LIATHROID AMHAIN, DHA MHAIDE.', 'BAC E, ANSIN DIRIGH LEIS AN gCIUMHAIS.', 'BUAFAIDH AN CHEAD DUINE GO 3.'], ctl: 'BOG: SUAS AGUS SIOS', pts: [0, 0], done: -1 };
  ...
  function point(i) {
    s.pts[i]++; shake = 6; sfx.score(); floatText(PL[i].name + ' A SCORAIL!', W / 2, 120, PL[i].col, 16); cheer(i, W / 2, 142, s.pts);
