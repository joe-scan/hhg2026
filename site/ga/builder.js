...
(() => {
  ...
  const HAIRNAMES = ['Dubh', 'Donn dorcha', 'Donn', 'Donn éadrom', 'Rua-donn', 'Rua', 'Fionn', 'Liath'];
  const SKINNAMES = ['Lightest', 'Éadrom', 'Éadrom measartha', 'Measartha', 'Measartha dorcha', 'Dorcha'];
  const KITNAMES = ['Gorm', 'Dearg', 'Glas', 'Buí', 'Corcra', 'Oráiste', 'Bándearg', 'Bán', 'Dubh'];
  const PETNAMES = ['Bán', 'Uachtar', 'Donnbhuí', 'Donn', 'Dubh', 'Liath'];
  ...
  function changed() {
    ...
    $('play-label').textContent = 'Imir cluiche ' + titleCase(c.hero.name) + '';
